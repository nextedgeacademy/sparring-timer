...
function WarmupMatchupPreview({ matchups, boxingGoal, muayThaiGoal }) {
  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-xl md:grid-cols-3 md:text-2xl xl:grid-cols-4">
      ...
      {(boxingGoal || muayThaiGoal) && (
        <div className="space-y-1 border-t border-white/10 pt-2 text-center text-2xl md:text-3xl">
